const Tags = {
  ...
  Scientific: { KeyValue: "Scientific", DisplayName: "علمی", CountOfPosts: 0, Href: "" },
  USA: { KeyValue: "USA", DisplayName: "آمریکا", CountOfPosts: 0, Href: "" },
  Russia: { KeyValue: "Russia", DisplayName: "روسیه", CountOfPosts: 0, Href: "" },
  Germany: { KeyValue: "Germany", DisplayName: "آلمان نازی", CountOfPosts: 0, Href: "" },
  ...
  WMD: { KeyValue: "WMD", DisplayName: "جنگ افزار های کشتار جمعی", CountOfPosts: 0, Href: "" },
  ...
  Ballistic: { KeyValue: "Ballistic", DisplayName: "موشک بالستیک", CountOfPosts: 0, Href: "" },
  Cruise: { KeyValue: "Cruise", DisplayName: "موشک کروز", CountOfPosts: 0, Href: "" },
...
let CategoriesArray = {
  ...
  ExpertPosts: {
    KeyName: "ExpertPosts",
    DisplayName: "مقالات علمی تخصصی",
    Tags: [Tags.Scientific],
    IconSrc: "CategoryImages/IranFlag.jpg",
  },
  NKNuclearProgram: {
    KeyName: "NKNuclearProgram",
    DisplayName: "برنامه هسته ای کره شمالی",
    Tags: [Tags.NorthKorea, Tags.Nuclear],
    IconSrc: "CategoryImages/NorthKorea.jpg",
  },
  ...
  IransBallisticMissile: {
    KeyName: "IransBallisticMissile",
    DisplayName: "موشک های بالستیک ایران",
    Tags: [Tags.Iran, Tags.Missile, Tags.Ballistic],
    IconSrc: "",
  },
  IransCruiseMissile: {
    KeyName: "IransCruiseMissile",
    DisplayName: "موشک های کروز ایران",
    Tags: [Tags.Iran, Tags.Missile, Tags.Cruise],
    IconSrc: "",
  },
  IranianDrones: {
    KeyName: "IranianDrones",
    DisplayName: "پهپاد های ایران",
    Tags: [Tags.Iran, Tags.Drones],
    IconSrc: "",
  },
  NaziNuclearProgram: {
    KeyName: "NaziNuclearProgram",
    DisplayName: "برنامه هسته ای رایش سوم",
    Tags: [Tags.Germany, Tags.Nuclear],
    IconSrc: "CategoryImages/EnglandFlag.jpg",
  },
  AirDefense: {
    KeyName: "AirDefense",
    DisplayName: "پدافند هوایی",
    Tags: [Tags.Iran, Tags.Airdefense],
    IconSrc: "",
  },
  SpaceAndSats: {
    KeyName: "SpaceAndSats",
    DisplayName: "ماهواره و برنامه های فضایی",
    Tags: [Tags.Iran, Tags.Satellite],
    IconSrc: "",
  },
  WMD: {
    KeyName: "WMD",
    DisplayName: "جنگ افزار های کشتار جمعی",
    Tags: [Tags.ChemicalAgents, Tags.WMD],
    IconSrc: "",
  },
};
let SocialMediasArray = [
  { Name: "تلگرام", Href: "https://t.me/arashdevx", Icon: "../Icons/TelegramIcon.png" },
  // { Name: "توییتر", Href: "", Icon: "../Icons/TwitterIcon.png" },
  // { Name: "یوتیوب", Href: "", Icon: "../Icons/YoutubeIcon.png" },
  { Name: "گیتهاب", Href: "https://github.com/InfinitDarknes", Icon: "../Icons/GitHubIcon.png" },
];
function UpdateTags() {
